...
wget -O /tmp/cuda_9.2.run \
    https://developer.nvidia.com/compute/cuda/9.2/Prod2/local_installers/cuda_9.2.148_396.37_linux
sudo sh /tmp/cuda_9.2.run --toolkit --toolkitpath=/usr/local/cuda-9.2 --silent
rm -rf /tmp/cuda_9.2.run
...
wget -O /tmp/cuda_10.0.run \
    https://developer.nvidia.com/compute/cuda/10.0/Prod/local_installers/cuda_10.0.130_410.48_linux
sudo sh /tmp/cuda_10.0.run --toolkit --toolkitpath=/usr/local/cuda-10.0 --silent
rm -rf /tmp/cuda_10.0.run
...
wget -O /tmp/cuda_10.1.run \
    https://developer.download.nvidia.com/compute/cuda/10.1/Prod/local_installers/cuda_10.1.243_418.87.00_linux.run
sudo sh /tmp/cuda_10.1.run --toolkit --toolkitpath=/usr/local/cuda-10.1 --silent
rm -rf /tmp/cuda_10.1.run
